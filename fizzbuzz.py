...
def get_fizzbuzz(_multiples: dict, exact_number=0, **kwargs):
    ...
    if exact_number != 0:
        ...
        min_range = int(kwargs.get('min_range')) if 'min_range' in kwargs else 1
        max_range = int(kwargs.get('max_range'))+1 if 'max_range' in kwargs else min_range+1
...
if __name__ == '__main__':
    ...
    result = get_fizzbuzz(multiples, min_range=1, max_range=100)
